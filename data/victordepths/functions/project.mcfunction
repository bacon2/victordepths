...
tp @s ^ ^ ^-1
execute store result entity @s Motion[0] double 0.0035 run scoreboard players get dx vcd_pos
execute store result entity @s Motion[1] double 0.0035 run scoreboard players get dy vcd_pos
execute store result entity @s Motion[2] double 0.0035 run scoreboard players get dz vcd_pos